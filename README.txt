...
This JavaFX application connects to the Binance WebSocket API to fetch the top 20 ask/bid orders for the `TBCUSDT` trading pair. The data is processed using the RXJava library for reactive programming.
...
- **Binance WebSocket API**: The API used to subscribe to real-time market data, specifically for the order book of the `TBCUSDT` trading pair.
